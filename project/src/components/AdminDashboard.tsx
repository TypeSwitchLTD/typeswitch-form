...
import { TrendingUp, Users, DollarSign, Target, Zap, AlertCircle, Download, RefreshCw, Package, Clock, CheckCircle, XCircle, Activity, Mail, ArrowDown, Calculator } from 'lucide-react';
